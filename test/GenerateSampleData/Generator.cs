...
namespace GenerateSampleData
{
	class Generator
	{
		...
		static void Main(string[] args)
		{
			...
			var sanctuary = SiteFactory.CreateObject(admin1context, new SanctuarySiteSchema("Sanctuary Site", typeof(SanctuarySite).FullName, currentRebellion.GUID, new GeoLocation(amstLocation.Coordinate.Latitude - 0.05, amstLocation.Coordinate.Longitude - 0.05), SchemaGenerator.SampleMarkdown));
