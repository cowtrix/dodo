...
namespace Dodo.Rebellions
{
	public class RebellionRESTHandler : GroupResourceRESTHandler<Rebellion>
	{
		public class CreationSchema : GroupResourceCreationSchema
		{
			...
			public CreationSchema(string name, string desc, GeoLocation location, DateTime start, DateTime end) : base(name, desc)
			{
				Location = location;
			}
		}
		...
		{
			return new CreationSchema("", "", default, new DateTime(2018), new DateTime(2019));
		}
