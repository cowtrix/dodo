...
namespace DodoServer
{
	public static class DodoServer
	{
		...
		public static string HttpsUri => $"https://{m_domains.Value}";
		public static string Homepage => $"https://{m_domains.Value}";
		...
		static ConfigVariable<List<string>> m_domains;
		...
		public static void Main(string[] args)
		{
			...
			m_domains = new ConfigVariable<List<string>>($"{Dodo.Dodo.PRODUCT_NAME}_Domain", new List<string>() { $"localhost:{Port}" });
