...
namespace Dodo
{
	public interface IDodoResource : IRESTResource
	{
		...
		bool IsAuthorised(User requestOwner, string passphrase, HttpRequest request, out EUserPriviligeLevel permissionLevel);
	}
	...
	public abstract class DodoResource : Resource, IDodoResource
	{
		...
		public abstract bool IsAuthorised(User requestOwner, string passphrase, HttpRequest request, out EUserPriviligeLevel permissionLevel);
	}
}
